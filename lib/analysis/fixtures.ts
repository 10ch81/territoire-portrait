    ...
    case "lowMunicipalDebt":
      return baseProfile("Commune dette faible", "99021", 10_000, 200, {
        ...
        publicAccounts: {
          ...
          operatingRevenuePerCapitaEur: 2_000,
          debtOutstandingEur: 6_500_000,
          debtPerCapitaEur: 650,
          grossSavingsEur: null,
          grossSavingsPerCapitaEur: 200,
          debtServiceEur: null,
          debtServicePerCapitaEur: 50,
          available: true,
          note: "",
        },
        security: {
    ...
    case "highMunicipalDebt":
      return baseProfile("Commune dette élevée", "99022", 10_000, 200, {
        ...
        publicAccounts: {
          ...
          grossSavingsEur: null,
          grossSavingsPerCapitaEur: 100,
          debtServiceEur: null,
          debtServicePerCapitaEur: 150,
          available: true,
          note: "",
        },
        security: {
    ...
    case "twoNegativeEnjeux":
      ...
      ...HOUSING_RP_EXTRA,
        ...
        publicAccounts: {
          ...
          grossSavingsEur: null,
          grossSavingsPerCapitaEur: 250,
          debtServiceEur: null,
          debtServicePerCapitaEur: 40,
          available: true,
          note: "",
        },
      });
